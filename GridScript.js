...
function pathfinding() {
	...
	if(selectedAlgo == 2 && biDirectional_search == false){	bi += 'Breadth Fist Search';	path= BFS(array, start_i, start_j, end_i, end_j);	}	
	...
	if(selectedAlgo == 2 && biDirectional_search == true){  bi +='Breadth First Search'; path = BFS(array, start_i, start_j, end_i, end_j);       alert("Kindly note that BFS is being impemented as BiBFS is not currently available");	}
